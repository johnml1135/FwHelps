---
title: "Infix Example screen shot"
source_title: "Infix Example screen shot"
breadcrumb:
  - "Morphology and Parsing Tasks"
  - "Infix Example screen shot"
source: "Morphology_and_Parsing_Tasks/Infix_Example_screen_shot.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Morphology_and_Parsing_Tasks/Infix_Example_screen_shot.htm"
...
- Here is a screen shot of the lexical entry ([Lexicon](../Using_Tools/Lexicon_tools/Lexicon_Edit/lexicon_edit_overview.md)) for the actor focus infix `–um-` (the object focus infix `–in-` would be similar):
  ...
  ![](../assets/images/Morphology_and_Parsing_Tasks/infix_actor_focus.png)
...
![](../assets/images/Morphology_and_Parsing_Tasks/infix_exam_texts.png)
