---
title: "Step 2 of 3: Field Mapping - words and glosses"
source_title: "Step 2 of 3: Field Mapping - words and glosses"
breadcrumb:
  - "Beginning Tasks"
  - "Importing Data"
  - "Import Standard Format Words and Glosses"
  - "Step 2 of 3: Field Mapping - Words and Glosses"
source: "Beginning_Tasks/Importing_Data/Import_SFM_words_and_glosses/Step_2_of_3_Field_Mapping_words_and_glosses.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Beginning_Tasks/Importing_Data/Import_SFM_words_and_glosses/Step_2_of_3_Field_Mapping_words_and_glosses.htm"
...
fw_help_version: "9.3"
page_heading: "Step 2 of 3: Field Mapping - SF words & glosses"
type: "topic"
content_hash: "sha256:fc05e5656d10ac2c"
---
...
2.  Do the following in the **Modify Mapping** dialog box:
    ...
    - Click the destination for the current marker. The destinations are limited to **Word Gloss**, **Wordform**, and **Don't Import**.
...
4.  When all the markers are mapped, click **Next**.
    ...
    [Step 3 of 3: Ready to Import](Step_3_of_3_Ready_to_Import_words_and_glosses.md) appears.

> [!TIP]
>
> - You can open the import file in a program, such as [ZEdit](../../../Basic_Tasks/ZEdit.md), to see the markers and data *while* you use the **Modify Mapping** dialog box.
>
> <!-- -->
>
