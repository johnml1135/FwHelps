---
title: "Bulk replace something with nothing"
source_title: "Bulk replace something with nothing"
breadcrumb:
  - "Lexicography Tasks"
  - "Bulk Replace something with nothing"
source: "Lexicography_Tasks/bulk_replace_something.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Lexicography_Tasks/bulk_replace_something.htm"
source_hash: "sha256:18f8b3364a5650ff4235ca9d73b9ba1a90362b3f54612977ddd38ccd417084b2"
keywords:
  - "Replace:Bulk Replace Something with Nothing"
  - "Bulk Edit Entries:Bulk replace something with nothing"
  - "Lexicography tasks"
related:
  ...
  - "Bulk replace nothing with something -> bulk_replace_nothing.md"
...
fw_help_version: "9.3"
type: "topic"
content_hash: "sha256:ff78e29b30062ffc"
---
...
This help topic helps you replace contents in a field with *nothing* (that is, remove the content).
...
4.  [Filter](../Basic_Tasks/Filtering_data/filtering_data_overview.md) or [sort](../Basic_Tasks/Sorting_data/Sorting_data_overview.md) the data to display the data you want to remove.
...
7.  Do the following in the dialog box:
    ...
    - In the **Find what** box, enter what you want to delete.
