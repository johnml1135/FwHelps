---
title: "Manage Classified Dictionary Layouts"
source_title: "Manage Classified Dictionary Layouts"
breadcrumb:
  - "User Interface"
  - "Menus"
  - "Tools"
  - "Configure Classified Dictionary"
  - "Manage Classified Dictionary Layouts"
source: "User_Interface/Menus/Tools/Configure_Classified_Dictionary/Manage_Classified_Dictionary_Views.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=User_Interface/Menus/Tools/Configure_Classified_Dictionary/Manage_Classified_Dictionary_Views.htm"
source_hash: "sha256:18f8b3364a5650ff4235ca9d73b9ba1a90362b3f54612977ddd38ccd417084b2"
keywords:
  - "Classified Dictionary:Manage Classified Dictionary Views"
  - "View:Manage Classified Dictionary Views"
  - "Manage:Classified Dictionary Views"
  - "Layouts:Manage Classified Dictionary Layouts"
  - "Layouts"
related:
  - "Configure Classified Dictionary layout dialog box -> Configure_Classified_Dictionary_View_dlgbox.md"
  - "Classified Dictionary layouts -> ../../../../Using_Tools/Lexicon_tools/Classified_Dictionary/Classified_Dictionary_overview.md"
  - "Tools menu overview -> ../Tools_overview.md"
fw_help_version: "9.3"
type: "topic"
content_hash: "sha256:7c4d91f77f074a20"
---
...
1.  On the Navigation pane, click **Lexicon**, and then **Classified Dictionary**.

2.  On the **Tools** menu, point to **Configure**, and then click **Classified Dictionary**.

    The **Configure Classified Dictionary** [dialog box](Configure_Classified_Dictionary_View_dlgbox.md) appears.

3.  Click the **Manage Layouts** button.

    The **Manage Dictionary Views** dialog box appears.
...
> [!TIP]
>
> - You *cannot* rename the default layout. Instead, simply copy and then rename the copy.
