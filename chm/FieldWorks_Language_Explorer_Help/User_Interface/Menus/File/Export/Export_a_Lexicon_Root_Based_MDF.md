---
title: "Export a lexicon (root-based SFM)"
source_title: "Export a lexicon (root-based SFM)"
breadcrumb:
  - "User Interface"
  - "Menus"
  - "File"
  - "Export"
  - "Export a lexicon (Root-based MDF)"
source: "User_Interface/Menus/File/Export/Export_a_Lexicon_Root_Based_MDF.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=User_Interface/Menus/File/Export/Export_a_Lexicon_Root_Based_MDF.htm"
...
fw_help_version: "9.3"
type: "topic"
content_hash: "sha256:f56cd3cdf50ae887"
---

# Export a lexicon (root-based SFM)

*User Interface › Menus › File › Export*

You can export a lexicon into a [root-based](../../Tools/Configure_Dictionary/Dictionary_views.md) MDF standard format. Subentries are exported as part of their main entry (indented below with headwords). The exported file actually includes writing system designators as part of the SFM code, so it is not pure MDF.
...
3.  In the dialog box, do the following:
    ...
    - In the left pane, select the export method **Full Lexicon (root-based) SFM**.
...
The **Exporting Full Lexicon (root-based)** progress box appears. When the export is finished, the progress box and the **Export** dialog box close automatically.
