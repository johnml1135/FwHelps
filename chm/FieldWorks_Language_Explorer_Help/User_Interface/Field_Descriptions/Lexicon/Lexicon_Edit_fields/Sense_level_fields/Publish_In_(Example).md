---
title: "Publish Example In"
source_title: "Publish Example In"
breadcrumb:
  - "User Interface"
  - "Field Descriptions"
  - "Lexicon"
  - "Lexicon Edit fields"
  - "Sense level fields"
  - "Publish Example In field"
source: "User_Interface/Field_Descriptions/Lexicon/Lexicon_Edit_fields/Sense_level_fields/Publish_In_(Example).htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=User_Interface/Field_Descriptions/Lexicon/Lexicon_Edit_fields/Sense_level_fields/Publish_In_%28Example%29.htm"
source_hash: "sha256:18f8b3364a5650ff4235ca9d73b9ba1a90362b3f54612977ddd38ccd417084b2"
keywords:
  - "Exclude:Exclude an example from Dictionary"
  - "Publish In fields:Publish Example In"
related:
  ...
  - "Show Subentry under field -> ../Publication_Settings_flds/Show_Subentry_under.md"
...
fw_help_version: "9.3"
page_heading: "Publish Example In field"
type: "topic"
content_hash: "sha256:0e6923965e37c2a8"
---
...
**Full name:** **Publish Example In**

**Location:**

In the **Entry** pane (**Lexicon Edit**).

[Example](example_field.md), [Translation](Translation_field.md), [Type](Type_field.md), [Reference](Reference_field.md) and **Publish Example In** fields are added when you [insert an example](../../../../../Using_Tools/Lexicon_tools/Lexicon_Edit/Insert_an_example_in_a_sense.md) in a sense or subsense.

Each example has a separate **Publish Example In** field.
...
- If this field contains a publication, then the example is *available* for display and for publishing. You will need to [select](../../../../../Using_Tools/Lexicon_tools/Dictionary/Select_a_publication.md) the publication and configure the view.

- If this field does *not* contain a particular publication, then the example is *unavailable* for display or for publishing.
