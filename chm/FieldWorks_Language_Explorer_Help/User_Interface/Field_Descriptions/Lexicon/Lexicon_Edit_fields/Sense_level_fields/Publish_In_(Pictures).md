---
title: "Publish Picture In"
source_title: "Publish Picture In"
breadcrumb:
  - "User Interface"
  - "Field Descriptions"
  - "Lexicon"
  - "Lexicon Edit fields"
  - "Sense level fields"
  - "Publish Picture In field"
source: "User_Interface/Field_Descriptions/Lexicon/Lexicon_Edit_fields/Sense_level_fields/Publish_In_(Pictures).htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=User_Interface/Field_Descriptions/Lexicon/Lexicon_Edit_fields/Sense_level_fields/Publish_In_%28Pictures%29.htm"
source_hash: "sha256:902c7d7196f408addc2e76cc7f471f0bac6efcb24cb42bbd21d8abe7fd0faf05"
keywords:
  - "Publish In fields:Publish Picture In"
related:
...
fw_help_version: "9.3"
page_heading: "Publish Picture In field"
type: "topic"
content_hash: "sha256:21ff1b323dff4c3f"
---
...
**Full name:** **Publish Picture In**

**Location:**

In the **Entry** pane (**Lexicon Edit**).

This **Publish Picture In** field appears with **Picture** fields in [senses](Sense_level_fields_overview.md) and subsenses. Each time you insert a picture, these fields appear: [Picture](Picture_field.md), [Thumbnail](Thumbnail_field.md), [Caption](caption_field.md), [File](File_field.md) and **Publish Picture In**.
...
- If this field contains a publication, then the picture is *available* for display and for publishing. You will need to [select](../../../../../Using_Tools/Lexicon_tools/Dictionary/Select_a_publication.md) the publication and configure the view.

- If this field does *not* contain a publication*,* then the picture is not available for display or for publishing.
