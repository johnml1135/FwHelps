---
title: "Set Occurrence (Complex Concordance)"
source_title: "Set Occurrence (Complex Concordance)"
breadcrumb:
  - "Using Tools"
  - "Texts & Words tools"
  - "Complex Concordance"
  - "Set Occurrence (Complex Concordance)"
source: "Using_Tools/Texts_&_Words_tools/Complex_Concordance/Set_Occurrence_(Complex_Concordance).htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Using_Tools/Texts_%26_Words_tools/Complex_Concordance/Set_Occurrence_%28Complex_Concordance%29.htm"
...
fw_help_version: "9.3"
page_heading: "Set occurrence (min. and max.)"
type: "topic"
content_hash: "sha256:417dedabcd4769de"
---
...
4.  Make sure the **Minimum** value is less than or equal to the **Maximum** value, and then click **OK**.
    ...
    - The values you set appear as a superscript and subscript on the side of the tall square brackets that surround the criteria. Example:\
      ![](../../../assets/images/Using_Tools/Texts_&_Words_tools/Complex_Concordance/Range.png)
