---
title: "Change homograph numbers"
source_title: "Change homograph numbers"
breadcrumb:
  - "Using Tools"
  - "Lexicon tools"
  - "Browse"
  - "Change homograph numbers"
source: "Using_Tools/Lexicon_tools/Browse/Change_homograph_numbers.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Using_Tools/Lexicon_tools/Browse/Change_homograph_numbers.htm"
source_hash: "sha256:902c7d7196f408addc2e76cc7f471f0bac6efcb24cb42bbd21d8abe7fd0faf05"
keywords:
  - "Change"
  - "Homograph numbers:Change homograph numbers"
  - "in Browse"
related:
  - "Lexicon Browse overview -> Lexicon_Browse_overview.md"
  - "Lexicon Edit overview -> ../Lexicon_Edit/lexicon_edit_overview.md"
  - "Reassign homograph numbers -> ../../../User_Interface/Menus/Tools/Language_Project_Utilities_overview.md"
fw_help_version: "9.3"
type: "topic"
content_hash: "sha256:f6c54d9a72090e6d"
---
...
Homograph numbers are automatically assigned to [entries](../Lexicon_Edit/About_Lex_Edit_fld_levels.md) with identical headwords. They reflect the order in which the entries were created.
...
2.  In the **Entries** pane, [configure the columns](../../../Basic_Tasks/Configure_Columns/Using_Configure_Columns_dialog_box.md) to show the **Homograph number** field as a column.

3.  Edit the homograph number value for each of the entries with identical headwords to specify the order in which you want them to appear.

> [!NOTE]
>
> - You can work with homographs number for each layout using these dialog boxes:
>
> - - [Configure Headword Numbers](../../../User_Interface/Menus/Tools/Configure_Headword_Numbers/Config_Hdwrd_Numbers_dialog_box.md) (**Dictionary** and **Reversal Indexes**)
>
>   - [Configure Headword Numbers, Classified Dictionary](../../../User_Interface/Menus/Tools/Configure_Headword_Numbers/Configure_Headword_Numbers_dialog_box_Classified_Dictionary.md)
