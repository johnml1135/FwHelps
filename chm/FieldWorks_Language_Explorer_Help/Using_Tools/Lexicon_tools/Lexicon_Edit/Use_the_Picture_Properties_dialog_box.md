---
title: "Using Picture Properties dialog box"
source_title: "Using Picture Properties dialog box"
breadcrumb:
  - "Using Tools"
  - "Lexicon tools"
  - "Lexicon Edit"
  - "Using Picture Properties dialog box"
source: "Using_Tools/Lexicon_tools/Lexicon_Edit/Use_the_Picture_Properties_dialog_box.htm"
source_url: "https://downloads.languagetechnology.org/fieldworks/Documentation/en/index.htm#t=Using_Tools/Lexicon_tools/Lexicon_Edit/Use_the_Picture_Properties_dialog_box.htm"
source_hash: "sha256:902c7d7196f408addc2e76cc7f471f0bac6efcb24cb42bbd21d8abe7fd0faf05"
keywords:
  - "Picture Properties dialog box"
  - "use"
  - "Using the Picture Properties dialog box"
related:
  - "Lexicon Edit overview -> lexicon_edit_overview.md"
fw_help_version: "9.3"
page_heading: "Using the Picture Properties dialog box"
type: "topic"
content_hash: "sha256:43f744fe739b92c4"
---
...
## ![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/getpicture.png) Get Picture

- Click the source: ![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/artofreading.png) **Image Galleries**, ![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/scanner.png) **Scanner**, ![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/camera.png) **Camera** or ![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/File.png) **File**.

- 1.  For **Image Galleries**, do either of these steps:

  <!-- -->

  1.  - If *Art Of Reading* version 3.1 (or later) is installed and you have the appropriate keyboard, you can type a word in the **Image Gallery** search box in other languages. Click the down-arrow (![](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/Lang_Down_Arrow.png)) that is next to the search box, and then click the desired language. Type the word that describes the picture you want to find.

      - For older versions of *Art of Reading*, in the search box, type an English word that describes the picture you want to find.

  <!-- -->

  2.  Click the search button (![pic](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/SearchEyeGlass.png)).
...
## ![pic](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/crop.png) Crop
...
2.  Click ![pic](../../../assets/images/Using_Tools/Lexicon_tools/Lexicon_Edit/crop.png) **Crop**.
